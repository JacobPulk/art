...
The other 3 values of the function determine the extent to which the hue, saturation, and brightness are to be shifted upwards or downwards from the main color. Before being applied, these values are scaled down by a value previously determined by the version's [Calmer](#calmer).
