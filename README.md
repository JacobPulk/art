...
The program can produce a wide diversity of images. Using it is analogous to bushwacking through a jungle of unpleasant functions or images to find areas with fruitful aesthetics.

The program is intended to be "simple", as far as following a number of constraints.

Essentially, an image is drawn in one pass from a single continuous function of the XY plane. There is no "composition" beforehand, no shapes, no sprites, no layers, and no glitches or other effects applied afterwards. More detail is at the [end of this page](#-How-it-does-not-work).

**This is a meta-program** in that these functions are generated by mini-programs called **schemes** and **themes**, which are themselves generated, saved, and/or executed by this program, according to your direction.
