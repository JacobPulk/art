...
Hence, you can curate outputs at multiple levels, choosing which images, **themes**, or **schemes** to save; and you can guide searches for new **schemes** and **themes** by adjusting settings.
