...
An image is drawn from a 6-valued mathematical function of the XY plane.  
At a given pixel, 3 of the values determine the "main" color based on a previously generated palette; the other 3 values adjust the color's hue/saturation/brightness.
