...
Essentially, an image is drawn in one pass from one continuous function of the XY plane. There is no "composition" beforehand, no shapes, no layers, and no glitches or other effects applied afterwards. More detail is at the [end of this page](#how-it-does-not-work).
