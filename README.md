...
`!!` will find a new **theme** for a random saved **scheme**. (Note: You will notice that this search sometimes investigates multiple schemes before finding a theme. This is intentional - see [Settings](#settings).)
