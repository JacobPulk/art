...
These 6 functions are generated by...
applying a **scheme**, which is a stochastic algorithm for generating functions composed of dozens or hundreds of atomic functions (like `X`, `Y`, `POW`, and `SIN`), and
applying a **theme**, which stochastically...
- influences the palette construction
- narrows the possibilities of the scheme
- assigns values to various parameters of the scheme's functions (like the exponent in `POW`)
- adjusts the final color calculation
